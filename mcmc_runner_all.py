...
if __name__ == "__main__":
    ...
    for run in range(args.number_of_runs):
        ...
        outname = f"{args.prefix}_{args.steps/1000}k_{args.start}_{run:0>2}.csv"
        print(outname)
        ...
        if args.summary_file:
            ...
            if os.path.exists(args.summary_file):
                ...
                sumfile.write("start_time,end_time,outfile_name,acceptance,number_of_districts,pop_tolerance,polsby_popper,mean_BVAP_ratio,black_reps,mean_CPVI,Dem_Prob,Rep_Prob,competitiveness, avg_competitiveness, competitive_districts, cut_edges\n")
